...
RegistrationParameters slam3d::declareRegistrationParams(rclcpp::Node* node, const std::string& name)
{
...
RosPclSensor::RosPclSensor(const std::string& name, Logger* logger, rclcpp::Node* node)
